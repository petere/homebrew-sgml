class DocbookDsssl < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any, yosemite:  "ed383b50e0d7399a804ccc2a28a7a44601f4ee96a622029197ae7df848d9a570"
    sha256 cellar: :any, mavericks: "2902ffe5125e293b00e839747e718f7c82e49379efe0a968b72a344acce71359"
  end
  ...
  test do
    ...
    if Formula["docbook-sgml"].any_version_installed? && Formula["openjade"].any_version_installed?
      ...
      EOS
      system "#{Formula["openjade"].bin}/openjade", "-d", prefix/"docbook-dsssl/html/docbook.dsl", "-t", "sgml",
             "-V", "nochunks", "-V", "rootchunk", "-V", "%use-id-as-filename%", "test.sgml"
